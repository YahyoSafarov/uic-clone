<template>
  <div class="bg_image">
    ...
    <section
      ...
      aria-label="hero"
      data-section
      style="background-image: url('../assets/images/uic-group-main_back.webp')"
    >
      <div class="container">
        <div class="hero-content">
          <div class="text-[440px] font-bold">
            <h1 class="headline -mt-[120px] -ml-[45px]">
              <svg
                aria-hidden="true"
          ...
          <div class="container media_text">
            <div
              class="relative z-50 flex justify-start flex-col items-start gap-4 -mt-36"
            >
              <p class="text-white font-[700] text-[54px] text-start">
                We offer digital <br />
                solutions
              </p>
              <p class="text-gray-300 font-bold text-[22px] mb-10">
                IN ANY DIFFICULTY
              </p>
            </div>
            <div class="button-group">
              <NuxtLink
                to=""
                class="button button-arrow bg-blue flex items-center gap-5"
              >
                Portfolio
                <svg
                  viewBox="0 0 6 9"
              ...
              <div>
                <NuxtLink class="flex gap-6 items-center btn__call">
                  ...
                  <img
                    src="../assets/images/phone-call-regular-24%20(1).png"
                    class="w-[18px]"
                    alt="no icon"
                  />
                </NuxtLink>
          ...
          <div class="flex justify-center items-center">
            <img
              src="https://uic.group/_next/image?url=%2Fimages%2Fmountain.webp&w=1920&q=75"
              class="absolute max-w-full w-[100%] top-[180px] f_image"
              alt="no image"
            />
          </div>
        </div>
        ...
        <!--        More components-->
        <!--        <div x-show="open" class="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50" x-data="{ open: true }">-->
...
.bg_image {
  background-image: linear-gradient(
    ...
    url("../assets/images/uic-group-main_back.webp");
  width: 100%;
  height: 100vh;
...
.headline {
  width: 100%;
  font: 25vw system-ui, sans-serif;
  font-weight: 900;
  height: 450px;
}
