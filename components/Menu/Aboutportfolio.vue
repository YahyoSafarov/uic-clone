<template>
  <div class="container py-7">
    <div class="bg-[#252527] p-14 rounded-[12px]" data-aos="fade-up">
      <div>
        <p class="text-white text-[17px]">
          "UIC Group" is the address of projects that have their own values and
          do not pass without quality control. Every opportunity and demand in
          our company serves to meet the needs of our customers with maximum
          efficiency. Our company is ready to serve customers not just as
      ...
      <div class="flex flex-col gap-10 items-center justify-center py-10">
        ...
        >
          ...
          <div class="none_media">
            <div
              class="border-b border-neutral-700 w-[920px] flex items-center justify-center ml-[122px]"
            ></div>
          </div>
        </div>
      </div>
      <div
        class="wrapper flex justify-center items-center"
        data-aos="fade-up"
        data-aos-anchor-placement="bottom-bottom"
      >
    ...
    >
      <p class="text-white">
        The presence of our SaaS systems (these are the majority of services on
        the Internet: email, CRM systems, task schedulers, web designers for
        creating sites, blogging platforms. That is, all cloud programs that
        allow you to solve specific tasks) and PaaS (management system
...
const item = [
  {
    id: 1,
    image: "https://uic.group/images/about/portfolio/about-safenetpay.svg",
    description:
  ...
  {
    id: 2,
    image: "https://uic.group/images/about/portfolio/about-prosm.svg",
    description:
  ...
  {
    id: 3,
    image: "https://uic.group/images/about/portfolio/about-express24.svg",
    description:
  ...
  {
    id: 4,
    image: "https://uic.group/images/about/portfolio/about-tdiu.svg",
    description:
  ...
  {
    id: 5,
    image: "https://uic.group/images/about/portfolio/about-vilz.svg",
    description:
  ...
  {
    id: 6,
    image: "https://uic.group/images/about/portfolio/about-ayoluchun.svg",
    description:
