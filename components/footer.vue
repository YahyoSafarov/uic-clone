<template>
  <div class="container py-20">
    <div class="flex gap-[2rem] media_flex">
      <div v-for="item in navigation" :key="item.name" :href="item.href">
        <div class="mb-10">
          <div>
            <NuxtLink to="/about" class="font-bold text-[20px]">{{
              item.name
            }}</NuxtLink>
          </div>
        </div>
    ...
    <div class="flex gap-20 items-center media_row">
      <ul class="flex items-center gap-[1rem] media_grid">
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/facebook.svg"
              alt="no icon"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/twitter.svg"
              alt="no icon"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/instagram.svg"
              alt="no image"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/telegram.svg"
              alt="no icon"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/linkedin.svg"
              alt="no icon"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/behance.svg"
              alt="no icon"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/dribbble.svg"
              alt="no icon"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img src="https://uic.group/images/socials/yelp.svg" alt="no icon"
          /></a>
        </li>
        <li>
          <a href="#"
            ><img
              src="https://uic.group/images/socials/trustpilot.svg"
              alt="no icon"
          /></a>
        </li>
      </ul>
      ...
      <div class="flex gap-6 items-center cursor-pointer">
        <div class="flex gap-4 items-center">
          <i
            data-v-56c03d90=""
            data-v-34700754=""
            class="icon hover:text-red-500 text-white"
            ><svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <p class="duration-300 font-bold hover:text-white">info@uic.group</p>
        </div>
        ...
        <div class="flex items-center gap-4 cursor-pointer">
          ...
          <p class="duration-300 font-bold hover:text-white">
            +998 71 200 70 07
          </p>
        </div>
      </div>
    ...
    <div>
      ...
      >
        <div data-v-34700754="" class="flex mt-4 sm:!mb-9 mb-[28px]">
          <p data-v-34700754="" class="text-[#FFFFFF] text-[15px] flex gap-2">
            © UIC GROUP <span data-v-34700754="">2024</span>
          </p>
        </div>
        <div data-v-34700754="" class="hidden lg:inline mb-[16px]">
          <a
            data-v-34700754=""
            aria-current="page"
            href="/"
            class="router-link-active router-link-exact-active md:gap-[8px] flex items-center justify-center lg:!flex text-center uic"
            ><i
              data-v-56c03d90=""
              data-v-34700754=""
              class="icon hover:text-red-500 uicLogo text-white opacity-[0.8]"
            >
              <svg
                width="60"
                height="32"
            ...
            ><i
              data-v-56c03d90=""
              data-v-34700754=""
              class="icon hover:text-red-500 uicIcon text-white opacity-[0.8] md:opacity-0"
              ><svg
                data-v-82c499f6=""
                width="91"
                height="21"
          ...
          <a
            ...
            ><div data-v-34700754="" class="flex items-center pl-3">
              <i
                data-v-56c03d90=""
                data-v-34700754=""
                class="icon hover:text-red-500 text-[#FFFFFF99] sm:mr-[10px] mr-0 lg:!ml-[19.5px] lg:!mr-[11.5px]"
                ><svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <div
              data-v-34700754=""
              class="whitespace-nowrap lg:!px-2.5 px-2 sm:px-2 xs:py-2 lg:!pt-[3px] lg:!pb-[6px] font-normal group-hover:bg-[#00A795] transition duration-300 ease-in-out bg-[#FFFFFF29] text-white rounded-6 lg:!text-[16px] xs:mb-[6px] xs:ml-[14px] xs:my-[6px] ml-[14px] mr-[6px] xs:text-[13px]"
            >
              Map
            </div></a
          >
...
const navigation = [
  {
    id: 1,
    name: "About us",
    icon: "https://uic.group/uic-images/socials/facebook.svg",
    src: "",
    text: "info@uic.group",
    href: "/about",
  },
...
ul li a:hover:before {
  transform: scale(1.1);
  box-shadow: 0 0 15px #1a8377;
}

ul li a:hover {
  color: #ffee10;
  box-shadow: 0 0 5px #1a8377;
  text-shadow: 0 0 5px #1a8377;
  background: #00a795;
}
